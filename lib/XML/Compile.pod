...
=item L<XML::Compile::WSDL11|XML::Compile::WSDL11> and L<XML::Compile::SOAP|XML::Compile::SOAP>
...
XML::Compile subroutine compileClient.  However, this results in huge files, so may not be
worth the effort.
...
XML::Compile-E<gt>B<addSchemaDirs>(DIRECTORIES)
