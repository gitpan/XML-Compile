...
XML trees, each added with L<addWSDL()|XML::Compile::WSDL/"Extension">.
...
XML::Compile::WSDL-E<gt>B<new>(XML, OPTIONS)

=over 4

The XML is the WSDL file, which is anything accepted by L<dataToXML()|XML::Compile/"Read XML">.
All options are also passed to create an internal L<XML::Compile::Schema|XML::Compile::Schema>
object.  See L<XML::Compile::Schema::new()|XML::Compile::Schema/"Constructors">
...
XML::Compile::WSDL-E<gt>B<knownNamespace>(NAMESPACE)
...
$obj-E<gt>B<addWSDL>(XML)

=over 4

Some XML, accepted by L<dataToXML()|XML::Compile/"Read XML"> is provided, which should represent
...
$obj-E<gt>B<prepare>([NAME], OPTIONS)

=over 4

Creates temporarily an L<XML::Compile::SOAP::Operation|XML::Compile::SOAP::Operation> with L<operation()|XML::Compile::WSDL/"Extension">,
and then calls C<prepare()> on that; a usual combination.
As OPTIONS, combine all possibilities for L<operation()|XML::Compile::WSDL/"Extension"> and
L<XML::Compile::SOAP::Operation::prepare()|XML::Compile::SOAP::Operation/"Use">.
...
should stick to the L<operation()|XML::Compile::WSDL/"Extension"> and XML::Compile::WSDL subroutine call methods.
...
This module is part of XML-Compile distribution version 0.16,
built on February 25, 2007. Website: F<http://perl.overmeer.net/xml-compile/>
