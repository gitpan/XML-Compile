...
$obj-E<gt>B<doesExtend>(EXTTYPE, BASETYPE)

=over 4

Returns true when the EXTTYPE extends the BASETYPE. See
XML::Compile::Schema::Namespaces subroutine doesExtend
...
This module is part of XML-Compile distribution version 1.19,
built on October 25, 2010. Website: F<http://perl.overmeer.net/xml-compile/>
