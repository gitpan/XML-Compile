...
can be anything what is acceptable by L<importDefinitions()|XML::Compile::Schema/"Administration">, which is
everything accepted by L<dataToXML()|XML::Compile/"Compilers"> or an ARRAY of those things.
...
XML::Compile::Schema-E<gt>B<addSchemaDirs>(DIRECTORIES|FILENAME)
...
L<XML::Compile::Schema::XmlReader|XML::Compile::Schema::XmlReader>
...
=head2 ComplexType with "mixed" attribute
...
XML::Compile::Schema subroutine new option mixed_elements currently only modifies the reader's
behavior; the writer's capabilities are limited.
See L<XML::Compile::Schema::XmlReader|XML::Compile::Schema::XmlReader>.
...
See respectively the L<XML::Compile::Schema::XmlReader|XML::Compile::Schema::XmlReader> and
L<XML::Compile::Schema::XmlWriter|XML::Compile::Schema::XmlWriter>.
...
with L<new(key_rewrite)|XML::Compile::Schema/"Constructors">, or to an existing schema object with
L<addKeyRewrite()|XML::Compile::Schema/"Accessors">.  The last defined rewrite rules will be applied
first.  These rules will be used in all calls to L<compile()|XML::Compile::Schema/"Compilers">.

Besides, you can use L<compile(key_rewrite)|XML::Compile::Schema/"Compilers"> to add rules which
...
=head3 rewrite when localName collides
...
=head3 pre-defined rewrite rules
...
This module is part of XML-Compile distribution version 0.87,
built on July 04, 2008. Website: F<http://perl.overmeer.net/xml-compile/>
