...
specify the data.
 ...
 Option              --Default
 attributeFormDefault  <undef>
 elementFormDefault    <undef>
 filename              undef
 source                undef
...
=head3 repetative sequence, choice, all
...
=head3 repetative substitutionGroups
...
This module is part of XML-Compile distribution version 0.99,
