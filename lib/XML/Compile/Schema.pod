...
With XML::Compile::Schema subroutine importDefinitions option element_form_default, you can correct whole
...
XML::Compile::Schema-E<gt>B<dataToXML>(NODE|REF-XML-STRING|XML-STRING|FILENAME|FILEHANDLE|KNOWN)
...
XML::Compile::Schema-E<gt>B<findSchemaFile>(FILENAME)
...
This module is part of XML-Compile distribution version 1.03,
built on March 25, 2009. Website: F<http://perl.overmeer.net/xml-compile/>
