...
See L<documentation in base class|XML::Compile/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|XML::Compile/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|XML::Compile/"Constructors">.
...
See L<documentation in base class|XML::Compile/"Accessors">.
...
See L<documentation in base class|XML::Compile/"Compilers">.
...
See L<documentation in base class|XML::Compile/"Administration">.
...
See L<documentation in base class|XML::Compile/"DETAILS">.
 
=head2 Comparison

See L<documentation in base class|XML::Compile/"Comparison">.
...
This module is part of XML-Compile distribution version 1.35,
built on June 28, 2013. Website: F<http://perl.overmeer.net/xml-compile/>
