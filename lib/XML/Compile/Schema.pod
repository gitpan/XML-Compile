...
XML::Compile::Schema::Translate, which implements the compilation.
...
Some OPTIONS are explained in XML::Compile::Schema::Translate.
...
See XML::Compile::Schema::Template::Reader.
...
This module is part of XML-Compile distribution version 0.90,
