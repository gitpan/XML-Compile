...
XML::Compile::Schema-E<gt>B<new>(OPTIONS)
...
XMLDATA must be acceptable for L<dataToXML()|XML::Compile/"Read XML">.  The OPTIONS are passed
to L<addSchemas()|XML::Compile::Schema/"Accessors">.

=back

$obj-E<gt>B<knownNamespace>(NAMESPACE)

XML::Compile::Schema-E<gt>B<knownNamespace>(NAMESPACE)
...
I<Example:> typical simpleContent example
...
I<Example:> typical complexType element
...
L<compile(check_occurs)|XML::Compile::Schema/"Compilers"> is C<false>.

I<Example:> two values for C<a>
...
I<Example:> use of the type selector
...
I<Example:> use of the ID selector
...
I<Error:> required is a XML::LibXML::Node

Use L<importDefinitions()|XML::Compile::Schema/"Accessors"> to specify schema's in any (other) form, like
as string.
