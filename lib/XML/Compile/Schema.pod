...
them -in any order- before you call XML::Compile::Schema subroutine compileClient.
...
the data or not.  See L<XML::Compile::Util::block_label()|XML::Compile::Util/"Other">.  So, about data
