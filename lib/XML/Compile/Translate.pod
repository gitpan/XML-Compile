...
function in this package is XML::Compile::Translate subroutine compileTree, and is called by
...
XML::Compile::Translate-E<gt>B<register>(NAME)
...
XML::Compile::Translate-E<gt>B<compile>(ELEMENT|ATTRIBUTE|TYPE, OPTIONS)
