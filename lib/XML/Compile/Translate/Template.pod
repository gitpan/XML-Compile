...
$obj-E<gt>B<new>(TRANSLATOR, OPTIONS)
...
$obj-E<gt>B<register>(NAME)

XML::Compile::Translate::Template-E<gt>B<register>(NAME)
...
XML::Compile::Translate::Template-E<gt>B<compile>(ELEMENT|ATTRIBUTE|TYPE, OPTIONS)
