...
See L<documentation in base class|XML::Compile::Translate/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|XML::Compile::Translate/"METHODS">.
 
=head1 DETAILS

See L<documentation in base class|XML::Compile::Translate/"DETAILS">.
 
=head2 Translator options

See L<documentation in base class|XML::Compile::Translate/"Translator options">.
