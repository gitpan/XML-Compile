...
I<Error:> either filename or filehandle required

I<Error:> freeze can only be called once

The various closures may have related variables, and therefore
need to be dumped in one go.

I<Error:> freeze needs PAIRS or a HASH

I<Error:> package name required
...
I<Error:> value with $name is not a code reference
