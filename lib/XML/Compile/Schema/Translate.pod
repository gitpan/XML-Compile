...
XML::Compile::Schema::Translate-E<gt>B<compileTree>(ELEMENT, OPTIONS)
...
I<Error:> $element is not an element or attribute

I<Error:> expecting an element name as point to start
