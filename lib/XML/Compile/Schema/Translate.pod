...
function in this package is L<compileTree()|XML::Compile::Schema::Translate/"METHODS">, and is called by
...
use namespaces.  (see L<XML::Compile::Schema::importDefinitions()|XML::Compile::Schema/"Accessors">)
...
XML::Compile::Schema::Translate-E<gt>B<compileTree>(ELEMENT|ATTRIBUTE|TYPE, OPTIONS)
...
This module is part of XML-Compile distribution version 0.78,
built on April 16, 2008. Website: F<http://perl.overmeer.net/xml-compile/>
