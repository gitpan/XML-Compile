...
I<Example:> before hook on user-provided HASH.
...
I<Example:> before hook on simpleType data
...
I<Example:> before hook with object for complexType
...
I<Example:> add an extra sibbling after the usual process
...
I<Example:> creating nodes with text
